#ifndef GLXWIN_NOLOAD_STYLE_H
#define GLXWIN_NOLOAD_STYLE_H
...
#include <inttypes.h>
  ...
  // Extension: EXT_fbconfig_packed_float
  ...
  // Extension: EXT_swap_control_tear
